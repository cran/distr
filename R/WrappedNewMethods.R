Beta <- function(shape1 = 1, shape2 = 2, ncp = 0) new("Beta", shape1 = shape1, shape2 = shape2, ncp = ncp)
...
Fd <- function(df1 = 1, df2 = 1, ncp = 0) new("Fd", df1 = df1, df2 = df2, ncp = ncp)
Gammad <- function(shape = 1, scale = 1) new("Gammad", shape = shape, scale = scale)
