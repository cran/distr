...
\svnidlong
{$HeadURL: svn+ssh://stamats@svn.r-forge.r-project.org/svnroot/distr/branches/distr-2.2/pkg/distr/inst/doc/newDistributions.Rnw $}
{$LastChangedDate: 2009-08-21 00:41:15 +0200 (Fr, 21. Aug 2009) $}
