...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/pkg/distr/vignettes/newDistributions.Rnw $}
{$LastChangedDate: 2015-11-06 18:17:45 +0100 (Fr, 06 Nov 2015) $}
{$LastChangedRevision: 1068 $}
